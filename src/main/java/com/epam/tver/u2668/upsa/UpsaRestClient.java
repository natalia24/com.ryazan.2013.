...
public class UpsaRestClient {
    ...
    public String getEmployees(String city, String primarySkill) {
        return restTemplate.getForObject(baseURL + "v3/employees?primarySkills={primarySkill}&cities={city}", String.class, primarySkill, city);
    }
}
